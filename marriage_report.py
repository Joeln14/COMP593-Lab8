...
def save_married_couples_csv(married_couples, csv_path):
    ...
    married_couples_df = pd.DataFrame(married_couples)

    csv = married_couples_df.to_csv(csv_path, index=False, header=['Person 1', 'Person 2', 'Anniversary'])
